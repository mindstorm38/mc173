...
blocks! {
    ...
    WATER_STILL/9:      Block::new("water_still", Material::Water, 100.0, 0.0).set_light_opacity(3),
    LAVA_MOVING/10:     Block::new("lava_moving", Material::Lava, 100.0, 0.0).set_light_emission(15),
    LAVA_STILL/11:      Block::new("lava_still", Material::Lava, 100.0, 0.0).set_light_emission(15),
